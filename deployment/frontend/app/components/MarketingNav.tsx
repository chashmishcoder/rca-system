...
const NAV: NavItem[] = [
  ...
  },
  {
    label: 'Solutions',
    children: [
      { label: 'Overview', href: '/solutions', desc: 'All solutions by role and industry' },
      { label: 'Maintenance Engineers', href: '/solutions/by-role/maintenance-engineers', desc: 'Reduce MTTR with AI-guided diagnostics' },
      { label: 'Plant Managers', href: '/solutions/by-role/plant-managers', desc: 'Full fleet health at a glance' },
      { label: 'Reliability Engineers', href: '/solutions/by-role/reliability-engineers', desc: 'Deep failure pattern analysis' },
      { label: 'Manufacturing', href: '/solutions/by-industry/manufacturing', desc: 'CNC, pumps, motors, conveyors' },
      { label: 'Oil & Gas', href: '/solutions/by-industry/oil-gas', desc: 'Compressors and rotating equipment' },
      { label: 'Utilities', href: '/solutions/by-industry/utilities', desc: 'Turbines, generators, transformers' },
    ],
  },
  { label: 'Pricing', href: '/pricing' },
  {
    label: 'Resources',
    children: [
      { label: 'Documentation', href: '/resources/docs', desc: 'Get started in minutes' },
      { label: 'Blog', href: '/resources/blog', desc: 'Guides, research, and updates' },
